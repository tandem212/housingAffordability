...
\titlegraphic{\includegraphics[width=0.21\linewidth]{Monogram Wordmark_RGB_186+K.png}}
...
\begin{columns}
    ...
    \begin{multicols}{2}
        ...
        \vspace{1em}
        \begin{tikzfigure*}
            \includegraphics[width=.75\linewidth]{Housing.png}
        \end{tikzfigure*}
        \vspace{1em}
    ...
    \end{multicols}
        ...
        \begin{tikzfigure}[Most players retire without reaching MLB.]
            \includegraphics[width=0.75\linewidth]{../outputs/acf_pacf/acf_pacf_01840.png}
        \end{tikzfigure}
        ...
        \begin{tikzfigure}[Positions and types of drafted players.]
            \includegraphics[width=0.75\linewidth]{../outputs/acf_pacf/acf_pacf_02116.png}
        \end{tikzfigure}
    ...
    \block{Results}{
        ...
        \begin{tikzfigure}[Predicted risks of Reaching MLB and Retiring across picks (average bonus) for LHP]
            ...
            \includegraphics[width=0.49\linewidth]{../outputs/plots/mlp_hist.png}
            ...
            \includegraphics[width=0.49\linewidth]{../outputs/plots/sarima_forecast_all_zips.png}
        ...
        \begin{tikzfigure}[Predicted risks of Reaching MLB for HS RHP across Round and Bonus]
            \includegraphics[width=.45\linewidth]{../outputs/plots/mlp_confusion_matrix.png}
        \end{tikzfigure}
        \vspace{.25em}
...
%        \begin{multicols}{2}
        \begin{tikzfigure}[Screenshot of deployed app (housing.eakarakas.com)]
            \includegraphics[width=.65\linewidth]{app_example.png}
        \end{tikzfigure}
