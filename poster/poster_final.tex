...
\begin{columns}
  ...
  \block{References}{
    \begin{enumerate}[leftmargin=1.6em, itemsep=6pt, label={[\arabic*]}]
      \item Truong et al.\ (2020). Housing price prediction via
        improved machine learning techniques. \textit{Procedia Comp.\ Sci.}
      \item Zhang et al.\ (2023). Housing price prediction using ML:
        Wenzhou as a case study. \textit{IJERPH.}
      \item Muralidharan \& Minu (2015). Regression and neural
        network models for prediction of house prices.
        \textit{J.\ Intell.\ Fuzzy Syst.}
      \item Zhang (2021). Random Forest for Boston house price
        prediction. \textit{J.\ Physics: Conf.\ Series.}
      \item Gupta, Kabundi \& Miller (2011). Forecasting the US real
        house price index. \textit{Econ.\ Modelling.}
    \end{enumerate}
  }
